    ...
    "elm:src/Main.elm"(exports) {
      (function(scope) {
        ...
        var _VirtualDom_init = F4(function(virtualNode, flagDecoder, debugMetadata, args) {
          var node2 = args && args["node"] ? args["node"] : _Debug_crash(0);
          node2.parentNode.replaceChild(
        ...
        var _VirtualDom_map = F2(function(tagger, node2) {
          return {
            $: 4,
            j: tagger,
            k: node2,
        ...
        function _VirtualDom_applyPatchReorder(domNode, patch) {
          ...
          for (var i = 0; i < inserts.length; i++) {
            ...
            var entry = insert.A;
            var node2 = entry.c === 2 ? entry.s : _VirtualDom_render(entry.z, patch.u);
            domNode.insertBefore(node2, domNode.childNodes[insert.r]);
          }
          if (frag) {
        ...
        function _VirtualDom_virtualize(node2) {
          if (node2.nodeType === 3) {
            return _VirtualDom_text(node2.textContent);
          }
          if (node2.nodeType !== 1) {
        ...
        var $author$project$Main$name = "World";
        ...
        var $author$project$Main$main = A2(
          ...
          _List_fromArray(
            [
              $elm$html$Html$text("Hello " + ($author$project$Main$name + "!"))
            ]
          )
        );
